...
Rectangle {
    ...
    property alias roomNameStr: roomName.text
    property alias availabilityStr: availability.text
    property alias remainingTimeStr: remainingTime.text
    property alias timeInfoStr: timeInfo.text
    property alias dateInfoStr: dateInfo.text
    property alias nextMeetingTimeStr: nextMeetingTime.text
